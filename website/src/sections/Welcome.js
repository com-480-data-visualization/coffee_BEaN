    ...
    <div className='hero-container' id="hero">
        <div className='content'>
            ...
            <div className='hero-sub'>
                {"COFFEE BEANS: Where do they grow? What are the varieties? How does different varieties taste like?..."}
                <br/>
                {"PEOPLE: What is their coffee drink preference? How much coffee they consume daily?..."}
            </div>
        </div>
    </div>
  );
